...
class Default_action_ToolbarItems_ClearCacheToolbarItemDropDown_543527dfad199e4f1f716f7cb6f4421590d50eb4 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output6 .= '" class="dropdown-item t3js-toolbar-cache-flush-action">
                <span class="dropdown-item-columns">
                    <span class="dropdown-item-column dropdown-item-column-icon text-';
$array8 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('cacheAction.severity', $array8)]);
