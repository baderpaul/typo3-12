...
class Default_action_MenuSubpages_e47da5fc0f4a365ed48e491912ecdddd51c61cbc extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output10 .= '
                <li class="list-group-item border-0 pe-0 p-lg-0">
                    <a href="';
$array11 = array (
);
...
$output21 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, ['']);
